...
THStack *hs = new THStack("hs",Form("channels activity Vmesh=-480V Vdrift=-1000V;strNum;Counts"));
...
TCanvas *cChannel_beam_profileT0T1 = new TCanvas("cChannel_beam_profileT0T1","cChannel_beam_profileT0T1");
      ...
      beam_profile_SUB1_T0T1->SetLineColor(kBlue);
      beam_profile_SUB0_T0T1->SetLineColor(kRed);
...
TLegend *legt0t1 = new TLegend(0.1,0.7,0.48,0.9);
        ...
        legt0t1->AddEntry(beam_profile_SUB1_T0T1, "Fe55 source CENTER", "lp");
...
THStack *hs1 = new THStack("hs1",Form("channels activity T4T5 RUN32;strNum;Counts"));
hs1->Add(beam_profile_SUB1_T4T5);
hs1->Add(beam_profile_SUB0_T4T5);
hs1->Add(beam_profile_diffSUB0SUB1_T4T5);
...
TCanvas *cChannel_beam_profileT4T5 = new TCanvas("cChannel_beam_profileT4T5","cChannel_beam_profileT4T5");
      ...
      beam_profile_diffSUB0SUB1_T4T5->SetLineColor(kGreen);
      hs1->Draw("nostack");
