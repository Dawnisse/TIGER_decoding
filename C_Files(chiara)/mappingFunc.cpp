...
void mappingFunc() {
   ...
   ifstream inFile("../../../TIGER_data/TB@CERN_2021/RUN_26/SubRUN_0_GEMROC_0_TL.datout.txt");


   TH2D *chn_time_dist_T0T1 = new TH2D("channels data time distribution     (T0T1)",  Form("channel data time distribution (T0 T1);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
   TH2D *chn_time_dist_T2T3 = new TH2D("channels data time distribution MM1 (T2T3)",  Form("channel data time distribution (T2 T3);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
   TH2D *chn_time_dist_T4T5 = new TH2D("channels data time distribution MM1 (T4T5)",  Form("channel data time distribution (T4 T5);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
   
   TH2D *chn_time_dist_after_selection_T0T1 = new TH2D("channels data time after selection distribution     (T0T1)",  Form("channel data time after selection distribution (T0 T1);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
   TH2D *chn_time_dist_after_selection_T2T3 = new TH2D("channels data time after selection distribution MM1 (T2T3)",  Form("channel data time after selection distribution (T2 T3);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
   TH2D *chn_time_dist_after_selection_T4T5 = new TH2D("channels data time after selection distribution MM1 (T4T5)",  Form("channel data time after selection distribution (T4 T5);strip;Time[s]"), 124, -0.5, 123.5,135,0,13.5);
...
//    cCH_time_dist->SaveAs("./plot/RUN_32/subRUN0/chn_time_dist_micromegas_bin0.1s.pdf");
...
//    cCH_time_dist_after_selection->SaveAs("./plot/RUN_32/subRUN0/chn_time_dist_after_selection_micromegas_bin0.1s.pdf");
