...
//functions for plot
    ...
    initFigTemplate();
//couloring histos
    efine_dist_T0T1_380->SetLineColor(kYellow);
    efine_dist_T0T1_390->SetLineColor(kRed);
    efine_dist_T0T1_400->SetLineColor(kGreen);
    efine_dist_T0T1_420->SetLineColor(kBrownCyan);
    efine_dist_T0T1_430->SetLineColor(kViolet);
    efine_dist_T0T1_440->SetLineColor(kOrange);
    efine_dist_T0T1_450->SetLineColor(kRose);
    efine_dist_T0T1_460->SetLineColor(kAquamarine);
    efine_dist_T0T1_470->SetLineColor(kBlue);
    efine_dist_T0T1_480->SetLineColor(kCyan);
    efine_dist_T0T1_490->SetLineColor(kBlack);
    efine_dist_T0T1_500->SetLineColor(kArmy);

//E fine data time distribution for each tiger

    TCanvas *hstack = new TCanvas("stucked histo","stucked histo");

        THStack *hs = new THStack("hs", "Efine distribution strip52;Efine[digits];counts");
    ...
    legend->AddEntry(efine_dist_T0T1_380,"Vmesh=-380 V","f");
    legend->AddEntry(efine_dist_T0T1_390,"Vmesh=-390 V","f");
    legend->AddEntry(efine_dist_T0T1_400,"Vmesh=-400 V","f");
    legend->AddEntry(efine_dist_T0T1_420,"Vmesh=-420 V","f");
    legend->AddEntry(efine_dist_T0T1_430,"Vmesh=-430 V","f");
    legend->AddEntry(efine_dist_T0T1_440,"Vmesh=-440 V","f");
    legend->AddEntry(efine_dist_T0T1_450,"Vmesh=-450 V","f");
    legend->AddEntry(efine_dist_T0T1_460,"Vmesh=-460 V","f");
    legend->AddEntry(efine_dist_T0T1_470,"Vmesh=-470 V","f");
    legend->AddEntry(efine_dist_T0T1_480,"Vmesh=-480 V","f");
    legend->AddEntry(efine_dist_T0T1_490,"Vmesh=-490 V","f");
    legend->AddEntry(efine_dist_T0T1_500,"Vmesh=-500 V","f");
    legend->Draw();
}